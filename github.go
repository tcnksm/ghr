...
type GitHub interface {
	...
	EditRelease(ctx context.Context, releaseID int, req *github.RepositoryRelease) (*github.RepositoryRelease, error)
...
func (c *GitHubClient) EditRelease(ctx context.Context, releaseID int, req *github.RepositoryRelease) (*github.RepositoryRelease, error) {
	release, res, err := c.Repositories.EditRelease(c.Owner, c.Repo, releaseID, req)
	if err != nil {
